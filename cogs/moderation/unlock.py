...
class Unlock(commands.Cog):
    ...
    async def unlock_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:speed_welcome:1277893518282592318> **Channel**: {channel.mention}\n<:speed_info:1277823235672768629> **Status**: Unlocked\n<:speed_ArrowRed:1278191483840761909> **Reason:** Unlock request by {ctx.author}",
            color=self.color
        )
