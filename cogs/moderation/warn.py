...
class Warn(commands.Cog):
    ...
    async def warn(self, ctx, user: discord.Member, *, reason=None):
        ...
        try:
            ...
            embed = discord.Embed(description=f"**<:speed_users:1277893558476472320> Target User:** [{user}](https://discord.com/users/{user.id})\n"
                                              ...
                                              f"**<:speed_info:1277823235672768629> Reason:** {reason_to_send}\n"
                                              f"**<:speed_general:1277892911689764924> Total Warns:** {total_warns}",
                                              color=self.color)
    ...
    async def clearwarns(self, ctx, user: discord.Member):
        try:
            ...
            embed = discord.Embed(description=f"<:speed_tick:1277893404805697558> | All warnings have been cleared for **{user}** in this guild.", color=self.color)
