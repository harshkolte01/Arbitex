...
class Kick(commands.Cog):
    ...
    async def kick_command(self, ctx, member: discord.Member, *, reason: str = None):
        ...
        embed = discord.Embed(
            description=(
                f"**<:speed_users:1277893558476472320> Target User:** [{member}](https://discord.com/users/{member.id})\n"
                f"<:speed_fun:1277893459562467389> **User Mention:** {member.mention}\n"
                f"<:speed_info:1277823235672768629> **Reason:** {reason}\n"
                f"<:speed_author:1277892998436229153> **DM Sent:** {dm_status}"
            ),
            color=self.color
        )
