...
from .events.loghandler import LogHandler
...
from .events.guildmemberadd import GuildMemberAdd
...
async def setup(bot: Olympus):
  cogs_to_load = [
        ...
        AutoBlacklist, LogHandler, Guild, Errors, Autorole2, Autorole, greet, AutoResponder,
        Mention, GuildMemberAdd, AutoRole, React, AntiMemberUpdate, AntiBan, AntiBotAdd,
