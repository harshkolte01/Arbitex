...
class Whitelist(commands.Cog):
    ...
    async def whitelist(self, ctx, member: discord.Member = None):
        if ctx.guild.member_count < 30:
            embed = discord.Embed(
                color=0x000000,
                description="<:speed_cross:1277893420735791130> | Your Server Doesn't Meet My 30 Member Criteria"
            )
        ...
        if not antinuke or not antinuke[0]:
            embed = discord.Embed(
                color=0x000000,
                description=(
                    f"**{ctx.guild.name} Security Settings <:speed_security:1277892984360403026>\n"
                    "Ohh No! looks like your server doesn't enabled Antinuke\n\n"
                    "Current Status : <:disabled:1341220087893463054>\n\n"
        ...
        if not member:
            ...
            embed.add_field(name="__**Usage**__", value=f"<:speed_reddot:1278193273575440445> `{prefix}whitelist @user/id`\n<:speed_reddot:1278193273575440445> `{prefix}wl @user`")
            embed.set_thumbnail(url=ctx.bot.user.avatar.url)
            return await ctx.send(embed=embed)
        ...
        if data:
            embed = discord.Embed(title="<:speed_cross:1277893420735791130> Error",
                color=0x000000,
        ...
        embed = discord.Embed(
            ...
            color=0x000000,
            description=(
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Ban**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Kick**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Prune**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Bot Add**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Server Update**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Member Update**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Channel Create**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Channel Delete**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Channel Update**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Role Create**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Role Delete**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Role Update**\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Mention** @everyone\n"
                f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **Webhook Management**"
        ...
        embed.set_footer(text=f"Developed by Arbitex Development™")
        ...
        try:
            ...
            if interaction.data["custom_id"] == "catWl":
                ...
                embed = discord.Embed(
                    ...
                    color=0x000000,
                    description=(
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Ban**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Kick**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Prune**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Bot Add**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Server Update**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Member Update**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Channel Create**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Channel Delete**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Channel Update**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Role Create**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Role Delete**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Role Update**\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Mention** @everyone\n"
                        f"<:disable2:1320293631726321695><:enable1:1320293638449926167> : **Webhook Management**"
                ...
                embed_description = "\n".join(f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **{name}**" for key, name in fields.items())
                ...
                for value in interaction.data["values"]:
                    ...
                    embed_description = embed_description.replace(f"<:disable1:1320293628484124703><:enable2:1320293641029156934> : **{fields[value]}**", f"<:disable2:1320293631726321695> <:enable1:1320293638449926167> : **{fields[value]}**")
    ...
    async def whitelistreset(self, ctx):
        ...
        await self.db.commit()
        embed = discord.Embed(title="<:speed_tick:1277893404805697558> Success",
            color=0x000000,
