...
class Welcomer(commands.Cog):
    ...
    async def simple_setup(self, ctx):
        ...
        async def submit_callback(interaction):
            ...
            if message_content:
                ...
                await interaction.response.send_message("<:speed_verification:1277892897072742400> Welcome message setup completed!")
        ...
        cancel_button = Button(emoji="<:speed_bin:1277892670727127062>", style=discord.ButtonStyle.secondary)
    ...
    color=discord.Color(embed_data["color"]) if embed_data["color"] else discord.Color(0x2f3136)
        ...
        async def submit_callback(interaction):
            ...
            await interaction.response.send_message("<:speed_verification:1277892897072742400> Embed welcome message setup completed!")
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<:speed_tick:1277893404805697558> Success"
    ...
    async def greet_channel(self, ctx):
        ...
        def generate_view(page):
            ...
            async def select_callback(interaction: discord.Interaction):
                ...
                await ctx.send(f"<:speed_verification:1277892897072742400> Welcome channel has been set to {selected_channel.mention}")
    ...
    async def greet_autodelete(self, ctx, time: str):
        ...
        await ctx.send(f"<:speed_verification:1277892897072742400> Auto delete duration has been set to **{auto_delete_duration}** seconds.")
