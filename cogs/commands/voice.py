...
class Voice(commands.Cog):
    ...
    async def _kick(self, ctx, *, member: discord.Member):
        ...
        embed2 = discord.Embed(title="<:speed_tick:1277893404805697558> Success",
    ...
    async def vcunmute(self, ctx, *, member: discord.Member):
        ...
        if member.voice.mute == False:
            embed2 = discord.Embed(title="<:speed_cross:1277893420735791130> Error",
            ...
            return await ctx.reply(embed=embed2)
        ch = member.voice.channel.mention
        embed3 = discord.Embed(title="<:speed_tick:1277893404805697558> Success",
    ...
    async def _moveall(self, ctx, *, channel: discord.VoiceChannel):
        ...
        try:
            ...
            embed3 = discord.Embed(title="<:speed_cross:1277893420735791130> Error",
