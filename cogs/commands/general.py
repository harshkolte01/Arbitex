...
class General(commands.Cog):
  ...
  async def membercount(self, ctx: commands.Context):
        ...
        embed.add_field(name="__Count Stats:__",
                        value=f"<:speed_team:1277892711327731817> Total Members: {total_members}\n<:speed_users:1277893558476472320> Total Humans: {total_humans}\n<:speed_bot:1277823196271214624> Total Bots: {total_bots}",
                        inline=False)

        embed.add_field(name="__Presence Stats:__", value=f"<:speed_online:1277892933491757140> Online: {online}\n<:speed_dnd:1277893386497687553> Dnd: {dnd}\n<:speed_idle:1277892842085154898> Idle: {idle}\n<:speed_offline:1277892857801211957> Offline: {offline}", inline=False)
  ...
  async def poll(self, ctx: commands.Context, *, message):
    ...
    await msg.add_reaction("<:speed_tick:1277893404805697558>")
    await msg.add_reaction("<:speed_cross:1277893420735791130>")
  ...
  @commands.command(name="users", help="checks total users of Arbitex.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  async def users(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      title=f"**<:speed_users:1277893558476472320> Arbitex Users**",
  ...
  async def wizz(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      ...
      description=f"**<:Caution:1279284925794750475> Successfully Wizzed {ctx.guild.name}**",
      color=self.color,
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="Arbitex Invite & Support!",
      description=
      f"> **[Arbitex - Invite Bot](https://discord.com/oauth2/authorize?client_id=1280093375630020648&permissions=2113268958&scope=bot)**\n> **[Arbitex - Support](https://discord.gg/yV7HbDYKS5)**",
      color=0x000000)
    ...
    invite = Button(
      ...
      url=
      'https://discord.com/oauth2/authorize?client_id=1280093375630020648&permissions=2113268958&scope=bot'
    )
