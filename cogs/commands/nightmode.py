...
class Nightmode(commands.Cog):
    ...
    async def nightmode(self, ctx):
        ...
        nightmode_embed.add_field(
            name="Usage",
            value="<:speed_reddot:1278193273575440445> `nightmode enable`\n<:speed_reddot:1278193273575440445> `nightmode disable`",
            inline=False
        )
    ...
    async def enable_nightmode(self, ctx):
        if ctx.guild.member_count < 50:  
            return await ctx.send(embed=discord.Embed(title="<:speed_cross:1277893420735791130> Access Denied",
                color=self.color,
        ...
        if not manageable_roles:
            return await ctx.send(embed=discord.Embed(title="<:speed_cross:1277893420735791130> Error",
                color=self.color,
        ...
        await ctx.send(embed=discord.Embed(title="<:speed_tick:1277893404805697558> Success",
            color=self.color,
