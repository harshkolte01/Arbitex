    ...
    async def extraowner(self, ctx, option: str = None, user: discord.Member = None):
        ...
        if option.lower() == 'set':
            ...
            if view.value is None:
                await message.edit(content="<:speed_duration:1277892806760726570> Confirmation timed out.", embed=None, view=None)
            elif view.value:
                ...
                await message.edit(content="<:speed_cross:1277893420735791130> Action cancelled.", embed=None, view=None)
            ...
            if not row:
                ...
                if view.value is None:
                    ...
                    await message.edit(content="<:speed_cross:1277893420735791130> Action canceled.", embed=None, view=None)
