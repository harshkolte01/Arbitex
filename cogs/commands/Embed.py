...
class Embed(commands.Cog):
    ...
    async def _embed(self, ctx):
        ...
        button_send = Button(label="Send Embed",  emoji="<:speed_verification:1277892897072742400>", style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji="<:speed_bin:1277892670727127062>", style=discord.ButtonStyle.danger)
