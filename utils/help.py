...
class View(discord.ui.View):
    ...
    def add_buttons(self):
        self.homeB = Button(label="", style=discord.ButtonStyle.secondary, emoji="<:previous:1269505369953144914>", command=self.set_page, args=0, ctx=self.ctx)
        self.backB = Button(label="", style=discord.ButtonStyle.secondary, emoji="<:backward:1269506795630755871>", command=self.to_page, args=-1, ctx=self.ctx)
        self.quitB = Button(label="", style=discord.ButtonStyle.danger, emoji="<:stop:1269506777708232776>", command=self.quit, ctx=self.ctx)
        self.nextB = Button(label="", style=discord.ButtonStyle.secondary, emoji="<:forward:1269506832812998697>", command=self.to_page, args=1, ctx=self.ctx)
        self.lastB = Button(label="", style=discord.ButtonStyle.secondary, emoji="<:skip:1269505346582478910>", command=self.set_last_page, ctx=self.ctx)
    ...
    def gen_embeds(self):
        ...
        options.append(
            discord.SelectOption(label="Home",
                                 emoji='<:speed_home:1277892755732959294>', description=""))
